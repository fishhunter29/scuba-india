  ...
  return (
    <header className="hero">
      ...
      <div className="hero-photo">
        ...
        <img src="/images/hero-havelock.jpg" alt="Scuba diving in Havelock (Swarajdweep), Andaman" />
        <span className="hero-photo-badge">
          <span className="star">★</span> {settings.rating_avg} · {settings.review_count > 0 ? `${settings.review_count} reviews` : 'PADI Dive Centre'}
        </span>
      </div>
    </header>
  );
